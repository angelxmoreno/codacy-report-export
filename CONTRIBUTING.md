# Contributing to codacy-report-export

Thank you for your interest in improving `codacy-report-export`! This project embraces open collaboration, and we appreciate contributions of all sizes: bug fixes, documentation improvements, tests, and new features.
...
2. **Fork & Clone:**
   ```bash
   git clone https://github.com/angelxmoreno/codacy-report-export.git
   cd codacy-report-export
   ```
